...
/**
 * Class for the dentist doctors type
 * contains field name
 * contains constructor
 * contains required method heal patient with parameter healPlan.
 */
public class Dentist extends BaseDoctor implements IHeal {
    String name;

    public Dentist(String department, String jobTitle, String name) {
    ...
    public void heal(long healPlan) {
        ...
        System.out.println("I heal like a dentist");
    }
}
